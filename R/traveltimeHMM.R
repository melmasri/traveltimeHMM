...
#'   to be provided if and only if \code{tripframe} is \code{NULL}.  Default is \code{NULL}.
...
#'   to be provided if and only if \code{tripframe} is \code{NULL}.  Default is \code{NULL}.
#' @param tripframe A data frame or equivalent object that contains one column for each of
...
#'   \code{timeBins} and \code{linkIds}.
...
traveltimeHMM <- function(logspeeds = NULL, trips = NULL, timeBins = NULL, linkIds = NULL, tripframe = NULL,
    ...
    if(!xor(frameAvailable, singleParamsAvailable))
      stop("Either 'tripframe' or all of 'logspeeds', 'trips', 'timeBins' and 'linkIds' must be provided.")
