...
r <- rbind(r,
           c("`logE`", "A numeric representing the estimate of the mean trip effect for the speed in km/h, on the log-scale.  Hence, speeds and trip effects are to be added *on the logarithmic scale* as prescribed in Woodard et al."))
